...
if __name__ == '__main__':
    ...
    train_set_file = os.getcwd() + '/train/' + net_type + '/' + data_type + ' ' + str(args.num) + '/Train_set.csv'
    test_set_file = os.getcwd() + '/test/' + net_type + '/' + data_type + ' ' + str(args.num)  + '/Test_set.csv'
    val_set_file = os.getcwd() + '/val/' + net_type + '/' + data_type + ' ' + str(args.num) +  '/Validation_set.csv'
